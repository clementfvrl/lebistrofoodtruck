        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-beige-400 rounded-lg shadow-xl mb-8 overflow-hidden">
                <div class="p-8 text-center">
                    ...
                    <p class="text-white text-lg">Entdecken Sie unsere köstlichen Burger, Beilagen und Getränke - frisch
                        zubereitet mit den besten Zutaten.</p>
                </div>
            </div>
                ...
                @foreach ($products as $product)
                    <div
                        ...
                        <div class="h-48 bg-beige-100 flex items-center justify-center relative">
                            ...
                            @else
                                <!-- Fallback SVG icons -->
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" class="w-24 h-24 text-orange-500"
                        ...
                        <div class="p-4">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <span
                                    class="font-bold text-orange-500">€{{ number_format($product->price, 2, ',', '.') }}</span>
                            </div>
                            ...
                            <button
                                class="bg-orange-500 text-white w-full py-2 rounded-md text-sm hover:bg-orange-600 transition-colors duration-200">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-12">
                ...
                <p class="text-gray-600 mb-2">Unsere Speisen können Allergene enthalten. Bitte fragen Sie unser Personal
                    für detaillierte Informationen.</p>
                <p class="text-gray-600">Wir kennzeichnen unsere Speisen mit folgenden Symbolen:</p>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                    <div class="flex items-center">
                        <span
                            class="inline-block w-6 h-6 mr-2 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs font-bold">G</span>
                        <span class="text-sm text-gray-700">Glutenhaltiges Getreide</span>
                    </div>
                    <div class="flex items-center">
                        <span
                            class="inline-block w-6 h-6 mr-2 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs font-bold">M</span>
                        <span class="text-sm text-gray-700">Milch/Laktose</span>
                    </div>
                    <div class="flex items-center">
                        <span
                            class="inline-block w-6 h-6 mr-2 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs font-bold">E</span>
                        <span class="text-sm text-gray-700">Eier</span>
                    </div>
                    <div class="flex items-center">
                        <span
                            class="inline-block w-6 h-6 mr-2 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs font-bold">N</span>
